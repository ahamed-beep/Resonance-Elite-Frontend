  ...
  return (
    <footer className="bg-[#1c1c1c] text-white pt-16 pb-8 md:mt-20">
      ...
      <div className="border-t border-gray-700 mt-12 pt-6">
        <div className=" mx-auto px-4 md:px-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
          <p className="text-gray-400 text-center md:text-left">
            © {new Date().getFullYear()} Resonance Elite. All rights reserved.
          </p>
          <p className="text-gray-400 text-center md:text-right">
            Developed by{" "}
            <a href="https://wisedesk.agency" target="_blank" rel="noopener noreferrer" className="text-white font-semibold hover:underline transition">
              WiseDesk Agency
            </a>
          </p>
        </div>
